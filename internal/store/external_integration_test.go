...
VALUES ('legacy-task', 'legacy goal', 'created', 1, 0, '', '', '[]', 1, '');`
	...
	defer st.Close()
	assertPostgresColumns(t, st.db, "tasks", "tenant_id", "session_id", "sequence_no", "created_at", "updated_at", "execution_mode", "token_budget", "llm_call_budget", "memories_json", "answer_audit_json")
